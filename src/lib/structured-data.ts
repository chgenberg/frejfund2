...
export const organizationSchema = {
  ...
  "description": "AI-powered platform connecting founders with investors. We help startups get funding through intelligent matching and investment readiness coaching.",
  "foundingDate": "2024",
  "founders": [
    {
      "@type": "Person",
  ...
  "sameAs": [
    "https://www.linkedin.com/company/frejfund",
    "https://twitter.com/frejfund"
  ]
};
...
export const howToSchema = {
  ...
  "description": "Step-by-step guide to securing investment for your startup using FrejFund's AI-powered platform",
...
export const softwareAppSchema = {
  ...
  "description": "AI-powered platform for startup funding. Get investment ready and connect with 500+ investors.",
