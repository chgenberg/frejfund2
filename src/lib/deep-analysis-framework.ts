...
export const ANALYSIS_DIMENSIONS: AnalysisDimension[] = [
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Describe the specific moment when a user of ${bi.companyName} realizes "wow, this is valuable". What's the hook? Content: ${content.slice(0, 2000)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `What's the growth rate of ${bi.companyName}'s target market? Look for: CAGR, "fastest growing", market trends. Content: ${content.slice(0, 2000)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Is ${bi.industry} a winner-take-all market or can multiple players co-exist? Assess consolidation potential.`,
  ...
  },
  {
    ...
    priority: 'low',
    prompt: (bi, content) => `Identify 3-5 adjacent markets ${bi.companyName} could expand into after dominating their core market. Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `What substitute products or workarounds exist for ${bi.companyName}? (e.g., Excel as CRM substitute). Are they vulnerable?`,
  ...
  },
  {
    ...
    priority: 'critical',
    prompt: (bi, content) => `Analyze ${bi.companyName}'s unit economics. Calculate or estimate: LTV, CAC, LTV:CAC ratio, CAC payback period, gross margins. Revenue: ${bi.monthlyRevenue}. Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `How predictable is ${bi.companyName}'s revenue? Subscription vs one-time? Annual contracts? Churn rate? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Assess ${bi.companyName}'s pricing power. Are they price-makers or price-takers? Could they 2x prices? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `What's ${bi.companyName}'s gross margin structure? Pure software (high), marketplace (medium), services (low)? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `Can you see a clear path to profitability for ${bi.companyName}? When? What needs to happen? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `How diversified are ${bi.companyName}'s revenue streams? Single product or multiple? Customer concentration risk? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `As ${bi.companyName} scales 10x, do margins improve (software) or compress (services)? Infrastructure costs? Content: ${content.slice(0, 1000)}`,
  ...
  // ===== CATEGORY 4: TRACTION & GROWTH (7 dimensions) =====
  {
    ...
    priority: 'critical',
    prompt: (bi, content) => `What's ${bi.companyName}'s MRR/revenue growth rate? Extract: MoM growth, YoY growth, growth charts. Current MRR: ${bi.monthlyRevenue}. Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `How many customers is ${bi.companyName} adding per month? Accelerating or flat? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'critical',
    prompt: (bi, content) => `What's ${bi.companyName}'s customer retention and churn rate? Look for: NRR, GRR, churn mentions, customer lifetime. Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'critical',
    prompt: (bi, content) => `Find evidence of Product-Market Fit for ${bi.companyName}: organic growth, word-of-mouth, customers begging for features, low churn. Content: ${content.slice(0, 2000)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `Calculate or estimate ${bi.companyName}'s sales efficiency (Magic Number = Net New ARR / Sales & Marketing Spend). Good if >0.75. Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Does ${bi.companyName} have viral growth? Referral program? Network effects? K-factor? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'low',
    prompt: (bi, content) => `What % of their Total Addressable Market has ${bi.companyName} captured? Are they 0.01% or 10%? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Evaluate the quality of ${bi.companyName}'s strategic decisions based on: market choices, positioning, features prioritized. Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Can ${bi.companyName} attract top talent? Look for: team quality, employer brand, careers page, perks. Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `How committed are ${bi.companyName}'s founders? Full-time? Self-funded initially? Previous exits that show they don't need the money? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `How diversified are ${bi.companyName}'s acquisition channels? Over-reliant on one (risky) or multiple working channels? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `Does ${bi.companyName} have expansion revenue opportunity? Upsells? Cross-sells? Usage-based pricing? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Can ${bi.companyName}'s tech architecture scale 10-100x or will it need rebuild? Any signals of technical debt? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `Does ${bi.companyName}'s product improve with more users or data? Network effects? Data moat? Content: ${content.slice(0, 1500)}`,
  ...
  // ===== CATEGORY 8: FUNDRAISING & CAPITAL (5 dimensions) =====
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `How capital efficient is ${bi.companyName}? Revenue per $ raised? Bootstrapped or heavily funded? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'critical',
    prompt: (bi, content) => `Is ${bi.companyName} ready for the funding stage they're targeting? Stage: ${bi.stage}. Revenue: ${bi.monthlyRevenue}. Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `Does ${bi.companyName} clearly articulate how they'll use investment capital? Specific milestones? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'critical',
    prompt: (bi, content) => `Calculate ${bi.companyName}'s runway and assess burn rate health. Are they default alive or dead? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `Based on ${bi.companyName}'s traction (MRR: ${bi.monthlyRevenue}, Stage: ${bi.stage}), what's a reasonable valuation range? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Could ${bi.companyName}'s market disappear or shrink significantly? Pandemic-specific? Fad? Technology obsolescence? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `Customer concentration risk: Does ${bi.companyName} have one big customer (>20% revenue) or diversified base? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Is there organic demand for ${bi.companyName}? Inbound leads? Waitlist? SEO traffic? Or purely outbound sales? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `For ${bi.companyName}, what's the repeat usage pattern? Daily active users? Renewal rates? Habitual usage? Content: ${content.slice(0, 1500)}`,
  ...
  // ===== CATEGORY 12: SOCIAL PROOF & TRACTION (4 dimensions) =====
  {
    ...
    priority: 'low',
    prompt: (bi, content) => `What press coverage has ${bi.companyName} received? TechCrunch? Industry publications? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Who has already invested in ${bi.companyName}? Notable angels? Tier 1 VCs? Strategic investors? Content: ${content.slice(0, 1500)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Who are ${bi.companyName}'s advisors? Industry experts? Former executives? How relevant? Content: ${content.slice(0, 1500)}`,
  ...
  // ===== CATEGORY 13: OPERATIONAL MATURITY (3 dimensions) =====
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `How mature are ${bi.companyName}'s operations? Sales playbook? Customer success process? Onboarding flow? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'high',
    prompt: (bi, content) => `Does ${bi.companyName} systematically track KPIs? Dashboard mentions? Data-driven culture? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'low',
    prompt: (bi, content) => `How well does ${bi.companyName} communicate? Regular updates? Transparency? Investor updates? Content: ${content.slice(0, 1000)}`,
  ...
  // ===== CATEGORY 14: RISKS & RED FLAGS (4 dimensions) =====
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Any signals of founder misalignment or conflict at ${bi.companyName}? Equity split issues? Unclear roles? Content: ${content.slice(0, 1000)}`,
  ...
  // ===== CATEGORY 15: STRATEGIC POSITIONING (3 dimensions) =====
  {
    ...
    priority: 'low',
    prompt: (bi, content) => `Who might acquire ${bi.companyName}? Strategic buyers in ${bi.industry}? Why? Content: ${content.slice(0, 1000)}`,
  ...
  },
  {
    ...
    priority: 'medium',
    prompt: (bi, content) => `Can ${bi.companyName} expand internationally or is it geographically constrained? Localization needed? Content: ${content.slice(0, 1000)}`,
...
export function getDimensionsByCategory(): Record<string, AnalysisDimension[]> {
  return ANALYSIS_DIMENSIONS.reduce((acc, dim) => {
    if (!acc[dim.category]) {
      acc[dim.category] = [];
    }
...
export function getDimensionsByPriority(priority: 'critical' | 'high' | 'medium' | 'low'): AnalysisDimension[] {
