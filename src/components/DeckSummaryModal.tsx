        ...
        >
          ...
          <div className="p-5 space-y-4">
            <textarea
              ...
              placeholder="Paste deck text or key slide content here..."
            ...
            {result && (
              <div>
                ...
                <div className="text-sm text-gray-900 border border-gray-200 rounded p-3 whitespace-pre-wrap">
                  {result.summary}
                </div>
