        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              By accessing or using FrejFund's services ("Services"), you agree to be bound by these Terms of Service ("Terms"). 
              If you do not agree to these Terms, please do not use our Services.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">2. Description of Services</h2>
            <p className="text-gray-700 mb-4">
              FrejFund provides an AI-powered platform that:
            </p>
            ...
            <p className="text-gray-700 mb-4">
              <strong>3.1 Account Creation:</strong> You may need to create an account to access certain features. 
            ...
            <p className="text-gray-700 mb-4">
              <strong>3.3 Account Security:</strong> You are responsible for all activities that occur under your account.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">4. Use of Services</h2>
            <p className="text-gray-700 mb-4">
              <strong>4.1 Permitted Use:</strong> You may use our Services only for lawful purposes and in accordance with these Terms.
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <h2 className="text-2xl font-bold text-black mt-8 mb-4">5. Content and Intellectual Property</h2>
            <p className="text-gray-700 mb-4">
              <strong>5.1 Your Content:</strong> You retain ownership of any content you submit to FrejFund. 
            ...
            <p className="text-gray-700 mb-4">
              <strong>5.2 Our Content:</strong> FrejFund and its licensors own all rights to the Services, 
              including all software, text, images, and other content.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">6. AI Analysis and Matching</h2>
            <p className="text-gray-700 mb-4">
              <strong>6.1 No Guarantee:</strong> Our AI analysis and investor matching are provided as tools to assist 
              in your fundraising journey. We do not guarantee funding, investor interest, or the accuracy of our analysis.
            </p>
            <p className="text-gray-700 mb-4">
              <strong>6.2 Not Financial Advice:</strong> Our Services do not constitute financial, investment, or legal advice. 
              Always consult with qualified professionals before making financial decisions.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">7. Privacy and Data Protection</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              <strong>8.2 Payment Terms:</strong> By purchasing a paid plan, you agree to pay all applicable fees. 
              Fees are non-refundable except as required by law.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">9. Disclaimers and Limitations of Liability</h2>
            <p className="text-gray-700 mb-4">
              <strong>9.1 "As Is" Basis:</strong> Our Services are provided "as is" and "as available" without warranties 
              of any kind, either express or implied.
            </p>
            <p className="text-gray-700 mb-4">
              <strong>9.2 Limitation of Liability:</strong> To the maximum extent permitted by law, FrejFund shall not be 
              liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use 
              or inability to use the Services.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">10. Indemnification</h2>
            <p className="text-gray-700 mb-4">
              You agree to indemnify and hold harmless FrejFund, its officers, directors, employees, and agents from 
            ...
            <p className="text-gray-700 mb-4">
              We may terminate or suspend your account and access to the Services at any time, with or without cause or notice. 
            ...
            <p className="text-gray-700 mb-4">
              <strong>FrejFund</strong><br />
              Email: legal@frejfund.com<br />
              Address: Stockholm, Sweden
            </p>

            <div className="mt-12 p-6 bg-gray-50 rounded-xl">
              <p className="text-sm text-gray-600 text-center">
                By using FrejFund, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
              </p>
            </div>
          </motion.div>
        </div>
