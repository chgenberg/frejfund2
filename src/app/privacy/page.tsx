        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-700 mb-6">
              At FrejFund, we take your privacy seriously. This Privacy Policy explains how we collect, use, 
              disclose, and safeguard your information when you use our AI-powered investment matching platform.
            </p>

            <h2 className="text-2xl font-bold text-black mt-8 mb-4">1. Information We Collect</h2>
            
            <h3 className="text-xl font-semibold text-black mt-6 mb-3">1.1 Information You Provide</h3>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li><strong>Account Information:</strong> Name, email address, password</li>
              <li><strong>Business Information:</strong> Company name, industry, stage, business model, revenue, team size</li>
              <li><strong>Financial Information:</strong> Revenue metrics, burn rate, runway (optional)</li>
              <li><strong>Documents:</strong> Pitch decks, business plans, financial statements you choose to upload</li>
              <li><strong>Communication Data:</strong> Messages with our AI coach, feedback, support inquiries</li>
            </ul>

            <h3 className="text-xl font-semibold text-black mt-6 mb-3">1.2 Information We Collect Automatically</h3>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
            ...
            <h2 className="text-2xl font-bold text-black mt-8 mb-4">3. How We Share Your Information</h2>
            
            <h3 className="text-xl font-semibold text-black mt-6 mb-3">3.1 With Your Consent</h3>
            <p className="text-gray-700 mb-4">
              We share your business information with investors only when you explicitly approve a match or introduction. 
              You control what information investors can see.
            </p>
            ...
            <h2 className="text-2xl font-bold text-black mt-8 mb-4">5. Your Rights (GDPR Compliance)</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              FrejFund is not intended for users under 18 years of age. We do not knowingly collect personal 
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              ...
              <li><strong>Analytics cookies:</strong> Help us understand usage (with consent)</li>
            ...
            <p className="text-gray-700 mb-4">
              ...
              local data protection authority. In Sweden, this is the Swedish Authority for Privacy Protection 
              (Integritetsskyddsmyndigheten).
            </p>

            <div className="mt-12 p-6 bg-gray-50 rounded-xl">
              <p className="text-sm text-gray-600 text-center">
                Your privacy is important to us. We are committed to protecting your data and being transparent 
                about how we use it to help you succeed in your fundraising journey.
              </p>
            </div>
          </motion.div>
        </div>
