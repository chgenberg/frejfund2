              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPreferences((prev) => ({ ...prev, vcEmail: e.target.value }))
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPreferences((prev) => ({ ...prev, vcFirm: e.target.value }))
                    }
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setPreferences((prev) => ({ ...prev, checkSizeMin: e.target.value }))
                        }
                        placeholder="500k"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setPreferences((prev) => ({ ...prev, checkSizeMax: e.target.value }))
                        }
                        placeholder="5M"
                        className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-black focus:outline-none"
                      />
