...
import { 
  Mail, Calendar, Database, Users, Brain, Shield, ArrowRight, 
  Check, Sparkles, TrendingUp, AlertCircle, MessageCircle,
  BarChart3, FileText, Zap, Clock, Target, ChevronLeft
} from 'lucide-react';
        ...
        <div className="space-y-3 sm:space-y-8 w-full">
          ...
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-xs sm:text-lg text-gray-700 leading-relaxed">
              Freja continuously monitors your business data to surface insights, 
              identify risks, and recommend specific actions.
            </p>
          </div>
              ...
              >
                <div className="flex items-center justify-between mb-2 sm:mb-4">
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <div>
                      <h3 className="font-medium text-black text-xs sm:text-base">{integration.name}</h3>
                    </div>
                  </div>
                  <div className={`w-4 h-4 sm:w-6 sm:h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                    selectedIntegrations.includes(integration.id)
                ...
                <p className="text-[10px] sm:text-xs text-gray-600 hidden sm:block">{integration.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6 flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-700">
                We never sell or share your data. Everything is encrypted end-to-end 
            ...
            {selectedIntegrations.length > 0 ? (
              <div className="space-y-3">
                {integrations
                  ...
                  .map((integration) => (
                    <div key={integration.id} className="bg-white rounded-lg p-4 border border-gray-200">
        ...
        <div className="space-y-8 max-w-3xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 text-center">
            ...
            <p className="text-sm text-gray-700">
              Founders using Freja report 3x faster decision-making and 
              catching critical issues 5 days earlier on average.
            </p>
          </div>
        </div>
      )
        ...
        <div className="space-y-8 text-center">
          ...
          <div className="max-w-2xl mx-auto space-y-4">
            ...
            <p className="text-lg text-gray-700">
              I'll start analyzing your business immediately and have your first insights ready in minutes.
            </p>
          </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 max-w-md mx-auto">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {integrations
                  .filter(int => selectedIntegrations.includes(int.id))
                  .map((integration) => (
                    <div key={integration.id} className="flex items-center space-x-2 bg-white rounded-lg px-3 py-2">
